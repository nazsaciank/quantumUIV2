...
const getLayouts = () => {
    ...
    return {
        lg: [
            ...
            { x: 20, y: 0,  w: 5,  h: recentTradesHeight,    i: '3', minH: minRecentTradesHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            ...
            { x: 14, y: 0,  w: 5,  h: orderBookHeight,       i: '6', minH: minOrderBookHeight,    minW: 4, isDraggable: isDraggable, isResizable: isResizable },
        ...
        md: [
            ...
            { x: 0,  y: 60, w: 24, h: recentTradesHeight,    i: '3', minH: minRecentTradesHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            ...
            { x: 16, y: 0,  w: 8,  h: orderBookHeight,       i: '6', minH: minOrderBookHeight,    minW: 4, isDraggable: isDraggable, isResizable: isResizable },
