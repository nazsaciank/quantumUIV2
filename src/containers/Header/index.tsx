...
import logo from '../../assets/images/logoNameIcon.svg';
import logoLight from '../../assets/images/logoNameIcon.svg';
            ...
            {shouldRenderHeader &&
                <header className={`pg-header`}>
                    <div className={`pg-container pg-header__content ${tradingCls}`}>
                        ...
                        <div className="pg-header__navbar flex-js-content__start">
